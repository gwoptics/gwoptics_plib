...
public class Complex {
	...
	/**
	 * This function computes the square of the complex number as (x + i y)*(x +
	 * i y)
	 * 
	 * @return
	 */
	...
	/**
	 * This function computes the square of a complex number as (x + i y) * (x +
	 * i y)
	 * 
	 * @param c
	 *            complex number
	...
	public Complex sqrt() {
		 ...
		 * which has been derived following the example in Numerical Recipes for
		 * C S. 949
		 */
...
//TODO: rewrite code from Numerical recipies, see below
	...
	/**
	 * This function multiplies the complex number by a real number and adds a phase delay
	 * as z=z*x*exp(i phi).
	 * 
	...
	/**
	 * This function multiplies a complex number by another given by amplitude and phase
	 * as return = z * abs * exp (i phi).
	 * 
	 * @param amp
	 * @param phi
	 * @param z
	 ...
	 * If the real or imaginary part is NaN this function returns `true'.
	 * 
	 * @return true if NaN
	 */
	 ...
	 * If the real or the imaginary part is NaN this function returns true.
	 * 
	...
	/**
	 * This function converts a complex number into a String "x + y i"
	 * with x being the real and y the imaginary part.
	 * 
	 * @return string
	 */
