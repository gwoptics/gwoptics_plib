...
public class VectorUtils {
	/**
	 * Rotates a given vector about an arbitrary axis. All rotations 
	 * are about the origin point to translations may be necessary
	 * after this step.
	 * 
	 * <p>Equation used in this code is from the book
	 * Mathematics for 3D game programming by Eric
	 * Lengyel, 2nd Edition, page 78,
	 * ISBN 1-58450-277-0.</p> 
	 * 
	 * @param P
	 * @param A
	 * @param theta
