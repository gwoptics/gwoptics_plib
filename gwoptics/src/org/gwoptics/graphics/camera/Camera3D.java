 ...
 * This camera setup is specifically useful for 'orbiting' around an object that is to be viewed. Rather
 * than applying the PApplet rotateX,rotateY and rotateZ, it uses matrix transformation to alter the
 * position of the camera in the world space.
 * </p>
 * <p>
 * To use the camera simply import the class and create a new Camera3D object. The class will register 
 * itself with the parent applet for draw() calls, and internally handles mouse events for rotations.
 * </p>
 * 
 * <p>
 * <b>History</b><br/>
 * Version 0.3.8 Added some static members to allow access too the various position, lookat and up vectors
 * of the camera.
 * <br/><br/>
 * Version 0.3.5 Orthographic view is added to camera class, can now be set using the setOthographicView
 * and setPerpectiveView methods
 * </p>
 * 
...
public final class Camera3D implements PConstants{
	...
	/** Gets a vector perpendicular to the eye vector pointing in the up
	 * direction. */
	...
	/** Gets a normalised vector stating the direction
	...
	/** Returns the up cross with eye vector, to get a
	...
	/** Gets the position of the camera relative to the
	...
	/** Sets default values of camera position to <100,100,100> and 
	 * look at position to <0,0,0>.
	 * 
	...
	/** Sets default camera properties as normal constructor but allows you to disable mouse
	 * events for a static camera.
	 * 
	...
	public void mouseEvent(MouseEvent event) {
		...
		case MouseEvent.MOUSE_DRAGGED:
			...
			if (_parent.mouseButton == PConstants.RIGHT
					|| (_parent.mouseButton == PConstants.LEFT && event
							.isControlDown())) {
