 ...
 * IColourmapEquation. 
 * 
 * <p>Before any values are read from the map, the map must have been generated using
 * generateColourmap() or a {@link MapNeedsGeneratingException} will be thrown.</p>
 * 
...
public class EquationColourmap implements IColourmap {
	...
	/**
	 * Use the supplied equation to generate colour values for each index in
	 * the colourmap. Must be called before map is used.
	 */
