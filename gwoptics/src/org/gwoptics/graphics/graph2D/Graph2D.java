...
public class Graph2D extends Renderable implements PConstants, IGraph2D {
	...
	public void setYAxisTickSpacing(float s){_ay.setTickSpacing(s);}
	/** Sets the minimum value to be shown on the X-Axis **/
	public void setXAxisMin(float val){_ax.setMinValue(val);}
	/** Sets the maximum value to be shown on the X-Axis **/
	public void setXAxisMax(float val){_ax.setMaxValue(val);}
	/** Sets the minimum value to be shown on the Y-Axis **/
	public void setYAxisMin(float val){_ay.setMinValue(val);}
	/** Sets the maximum value to be shown on the Y-Axis **/
	public void setYAxisMax(float val){_ay.setMaxValue(val);}
	...
	public void setXAxisLabelPos(LabelPos lblpos){_ax.setAxisLabelPos(lblpos);} 
	/** Sets the label position for the Y-Axis **/
	public void setYAxisLabelPos(LabelPos lblpos){_ay.setAxisLabelPos(lblpos);} 
	...
	/** */
	public IGraph2DBackground getGraphBackground() {return _back;}
	/** */
	public Axis2D getXAxis() {return _ax;}
	/** */
	public Axis2D getYAxis() {return _ay;}	
	/** Removes border **/
	...
	/**
	 * Method to add an object that has implements the IGraphTrace interface. Throws
	 * exception if trace is null. Returns an integer which represents the index of 
	...
	/**
	 * Removes a trace from the graph depending on its index. Index of trace increase
	 * from 0 by 1 for each trace added.
	 *  
	 * @param trace
	 */
	 ...
	 * Normally called from draw loop
	 */
	@Override
	public void draw() {
		if(_crossAxesAtZero)
